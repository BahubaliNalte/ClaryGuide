...
export default function About() {
	...
	return (
		<div className="min-h-screen bg-gradient-to-br from-[#f6fcfd] via-[#e3eaff] to-[#c1f2e7] flex flex-col">
			...
			<div
				id="mobileDrawer"
				className="fixed top-0 left-0 w-full h-full bg-white z-50 hidden md:hidden animate-fade-in"
			>
				<div className="flex flex-col items-end p-6">
					<button
						className="text-3xl text-[#2386ff] mb-8"
						onClick={() => {
			...
			<main className="flex-1 w-full px-2 py-0 animate-fade-in">
				...
				<section className="w-full bg-gradient-to-r from-[#e3eaff] via-[#f6fcfd] to-[#c1f2e7] py-16 flex flex-col items-center justify-center mb-0 rounded-b-3xl shadow-lg">
					<h2 className="text-5xl font-extrabold text-[#2386ff] mb-4 text-center drop-shadow-lg">
						About ClaryGuide
					</h2>
					<p className="text-xl text-[#1a3c6b] mb-6 text-center max-w-2xl">
						ClaryGuide is dedicated to helping students find clarity in their
						career paths through AI-powered guidance, visual roadmaps, and college
						information.
					</p>
				</section>
				...
				<section className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 mb-16 px-2">
					<div className="bg-white/90 rounded-3xl shadow-xl p-8 flex flex-col items-center border-t-4 border-[#2386ff] hover:scale-[1.02] transition-transform duration-200">
						<h3 className="text-2xl font-bold text-[#2386ff] mb-3">
							Our Vision
						</h3>
						<p className="text-[#1a3c6b] text-lg text-center">
							Empower every student to make informed career choices and achieve
							their dreams with clarity and confidence.
						</p>
					</div>
					<div className="bg-white/90 rounded-3xl shadow-xl p-8 flex flex-col items-center border-t-4 border-[#00bfae] hover:scale-[1.02] transition-transform duration-200">
						<h3 className="text-2xl font-bold text-[#00bfae] mb-3">
							Our Goals
						</h3>
						<p className="text-[#1a3c6b] text-lg text-center">
							Provide personalized career guidance, easy access to college info,
							and visual roadmaps for every career journey.
						</p>
					</div>
				</section>
				...
				<section className="w-full bg-gradient-to-br from-[#e3eaff]/60 via-[#f6fcfd]/80 to-[#c1f2e7]/60 py-12 px-2 rounded-3xl shadow-lg mb-8">
					<h3 className="text-4xl font-bold text-[#2386ff] mb-10 text-center drop-shadow">
						Meet Our Team
					</h3>
					<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 max-w-5xl mx-auto">
						{team.map((member, idx) => (
							<div
								key={idx}
								className="bg-white rounded-3xl shadow-xl p-8 flex flex-col items-center gap-3 hover:scale-105 transition-transform duration-200 border-t-4 border-[#e3eaff]"
							>
								<div className="w-24 h-24 mb-3 flex items-center justify-center overflow-hidden rounded-full border-4 border-[#2386ff] shadow-lg bg-white">
									<Image
										...
										className={`rounded-full w-full h-full ${
											member.name === "Krishna Saxena"
												? "object-contain"
												: "object-cover"
										}`}
									/>
								</div>
								<h4 className="font-bold text-xl text-[#2386ff] text-center mb-1">
									{member.name}
								</h4>
			...
			<footer className="bg-gradient-to-r from-[#f7fdfc] via-[#e3eaff] to-[#c1f2e7] text-[#6b7280] py-8 text-base mt-16 border-t border-[#e0e7ef] animate-fade-in">
				<div className="max-w-6xl mx-auto flex flex-col sm:flex-row flex-wrap sm:justify-between items-center gap-6 px-4">
					<div className="flex items-center gap-2 mb-4 sm:mb-0">
						...
						/>
						<span className="font-bold text-[#2386ff] text-lg animate-slide-in">
							ClaryGuide
						</span>
					</div>
					<div className="flex flex-col sm:flex-row gap-4 sm:gap-8 flex-wrap text-lg items-center justify-center w-full sm:w-auto mb-4 sm:mb-0">
						<Link
							href="/"
							className="hover:text-[#2386ff] hover:scale-105 transition-transform duration-200"
						>
							Home
						</Link>
						<Link
					...
					<div className="text-base text-[#8D44FF] animate-fade-in text-center w-full sm:w-auto">
						&copy; 2025 ClaryGuide. All rights reserved.
					</div>
				</div>
			</footer>
		</div>
